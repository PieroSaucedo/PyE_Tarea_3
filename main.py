...
#Genera muestras de distribución binomial.
...
#Genera muestras de distribución geométrica.
def generate_random_samples_geom():
    samples = {}
    for size in sizes:
        samples[size] = geom.rvs(pgeom, size=size)
    return samples
#Genera muestras de distribución de Poisson.
...
#Genera diagrama de cajas a partir de las muestras
...
#Genera histograma a partir de las muestras
...
#Calcula y muestra en pantalla diferentes estadísticas
